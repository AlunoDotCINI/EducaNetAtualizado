...
export default function alunos(){
    return(
        <div className={style.corpo}>
            ...
            <Link to="/teacher/courses"className={style.direcionador}><li className={style.direcionador}><FontAwesomeIcon icon={faChartLine} size="xs" style={{color: "#000000",}} className={style.logodash}/>CURSOS</li></Link>
            </ul>
