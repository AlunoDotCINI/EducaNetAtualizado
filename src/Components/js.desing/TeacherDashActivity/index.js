        ...
        <section className={style.conteudo}>
            <div className={style.conteudocards}>
                ...
                <div className={style.CardDois}>
                    <Link to="/teacher/activity/PostActivity"><button className={style.poste_atividades}>POSTE UM ATIVIDADE AQUI</button></Link>
                </div>
            </div>
            <div className={style.CardTres}>
                ...
                <div className={style.atividadeeditar}>
                    ...
                    <Link to="/teacher/activity/EditActivity"><button className={style.botaoeditar}>Editar</button></Link>
